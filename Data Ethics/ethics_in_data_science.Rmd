...
use_logo(image_url = "ethics_in_data_science_files/gfa_logo_clear.png",
...
.pull-right[
.center[![le](ethics_in_data_science_files/love run-6.jpg)]
![fam](ethics_in_data_science_files/family.jpg)
]
...
- Our public safety section is currently working on a project to track which 
police officers are assigned to each beat (route within a district)
- The Chicago Police Department has pushed back on providing this data as 
they’re worried about people using this data to time criminal activities
- For example, if you know this area is understaffed at a certain time you might 
be more inclined to commit a crime at that location during that time

---

class: left, middle

# Chicago Police (continued)

1. What are the benefits if Chicago PD were to provide this data?
2. What are the challenges?
3. Is it ethical for Chicago PD to withhold this data?

---

class: left, middle

# Michigan Pathways to Potential Program

*From Tyler Foley*

- Michigan is required to allow school aid funds to be used for the Pathways to 
Potential Program created by the Department of Health and Human Services (MDHSS)
- Both MDHSS and the Michigan Department of Education (MDE) support the sharing 
of education data with public health data to evaluate the effectiveness of the 
Pathways to Potential program
- There is interest in using education data beyond evaluation purposes and 
include sharing state data with success coaches across the state to identify 
students for receiving supports through Pathways to Potential
- While enabling the ability for success students to reach additional students 
would likely increase student outcomes, there is potential for biased decisions 

---

class: left, middle

# Michigan Pathways to Potential Program (continued)

1. Could an algorithm do better?
2. Could we design a way to test our hypothesis?
